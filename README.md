...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/l4p8vmpd/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg jekyll --sanity-project-id l4p8vmpd --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://knowledgeable-kale-c5744.sanity.studio/.
...
Generated at `2021-10-05T13:50:13.775Z` by Stackbit version `0.3.55`.